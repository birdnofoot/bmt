 ...
 */
public class BaculaJobRunningClientDto extends AbstractJobRunningDto{
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + Objects.hashCode(this.filesExamined);
        hash = 97 * hash + Objects.hashCode(this.processingFile);
        hash = 97 * hash + Objects.hashCode(this.SDReadSeqNo);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final BaculaJobRunningClientDto other = (BaculaJobRunningClientDto) obj;
