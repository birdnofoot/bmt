 ...
 */
public class BaculaJobRunningStorageDto extends AbstractJobRunningDto {
    ...
    public int hashCode() {
        ...
        hash = 53 * hash + Objects.hashCode(this.device);
        hash = 53 * hash + Objects.hashCode(this.spooling);
        hash = 53 * hash + Objects.hashCode(this.despooling);
        hash = 53 * hash + Objects.hashCode(this.despoolWait);
        hash = 53 * hash + Objects.hashCode(this.FDReadSeqNo);
        hash = 53 * hash + Objects.hashCode(this.inMsg);
        hash = 53 * hash + Objects.hashCode(this.outMsg);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final BaculaJobRunningStorageDto other = (BaculaJobRunningStorageDto) obj;
