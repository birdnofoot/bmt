 ...
 */
public class BaculaFileSystemDto implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 83 * hash + Objects.hashCode(this.group);
        hash = 83 * hash + Objects.hashCode(this.links);
    ...
    public boolean equals(Object obj) {
        ...
        final BaculaFileSystemDto other = (BaculaFileSystemDto) obj;
