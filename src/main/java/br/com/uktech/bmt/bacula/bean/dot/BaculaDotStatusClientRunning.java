 ...
 */
public class BaculaDotStatusClientRunning implements Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 23 * hash + Objects.hashCode(this.jobId);
        hash = 23 * hash + Objects.hashCode(this.job);
        hash = 23 * hash + Objects.hashCode(this.vss);
        hash = 23 * hash + Objects.hashCode(this.level);
        hash = 23 * hash + Objects.hashCode(this.jobType);
        hash = 23 * hash + Objects.hashCode(this.jobStarted);
        hash = 23 * hash + Objects.hashCode(this.files);
        hash = 23 * hash + Objects.hashCode(this.bytes);
        hash = 23 * hash + Objects.hashCode(this.bytesSec);
        hash = 23 * hash + Objects.hashCode(this.errors);
        hash = 23 * hash + Objects.hashCode(this.filesExamined);
        hash = 23 * hash + Objects.hashCode(this.processingFile);
        hash = 23 * hash + Objects.hashCode(this.sdReadSeqNo);
        hash = 23 * hash + Objects.hashCode(this.fd);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final BaculaDotStatusClientRunning other = (BaculaDotStatusClientRunning) obj;
    ...
    public String toString() {
        return "BaculaDotStatusClientRunning{" + "jobId=" + jobId + ", job=" + job + ", vss=" + vss + ", level=" + level + ", jobType=" + jobType + ", jobStarted=" + jobStarted + ", files=" + files + ", bytes=" + bytes + ", bytesSec=" + bytesSec + ", errors=" + errors + ", filesExamined=" + filesExamined + ", processingFile=" + processingFile + ", sdReadSeqNo=" + sdReadSeqNo + ", fd=" + fd + '}';
    }
