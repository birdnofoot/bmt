 ...
 */
public class BaculaStorage implements Serializable{
    ...
    public boolean equals(Object obj) {
        ...
        final BaculaStorage other = (BaculaStorage) obj;
    ...
    public String toString() {
        return "name=" + name + ", storageId=" + storageId + ", address=" + address + ", SDport=" + SDport + ", maxJobs=" + maxJobs + ", deviceName=" + deviceName + ", mediaType=" + mediaType;
    }
}