 ...
 */
public class ParseDotStorage extends ParseDot<BaculaDotStorage> {

    public final Logger logger = LoggerFactory.getLogger(ParseDotLevels.class);

    @Override
    protected BaculaDotStorage createObject(String value) {
        BaculaDotStorage storage = new BaculaDotStorage();
