 ...
 */
public class BaculaRestoreJob implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + Objects.hashCode(this.storages);
        hash = 97 * hash + Objects.hashCode(this.sdDevices);
        hash = 97 * hash + Objects.hashCode(this.fileNumbers);
        hash = 97 * hash + Objects.hashCode(this.jobQueued);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final BaculaRestoreJob other = (BaculaRestoreJob) obj;
    ...
    public String toString() {
        return "BaculaRestoreJob{" + "volumes=" + volumes + ", storages=" + storages + ", sdDevices=" + sdDevices + ", fileNumbers=" + fileNumbers + ", jobQueued=" + jobQueued + '}';
    }
