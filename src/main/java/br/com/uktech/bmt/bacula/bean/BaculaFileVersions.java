 ...
 */
public class BaculaFileVersions implements Serializable {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 47 * hash + Objects.hashCode(this.pathId);
        hash = 47 * hash + Objects.hashCode(this.fileNameId);
        hash = 47 * hash + Objects.hashCode(this.fileId);
        hash = 47 * hash + Objects.hashCode(this.jobId);
        hash = 47 * hash + Objects.hashCode(this.LStat);
        hash = 47 * hash + Objects.hashCode(this.md5);
        hash = 47 * hash + Objects.hashCode(this.volName);
        hash = 47 * hash + Objects.hashCode(this.Inchanger);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final BaculaFileVersions other = (BaculaFileVersions) obj;
    ...
    public String toString() {
        return "BaculaFileVersions{" + "pathId=" + pathId + ", fileNameId=" + fileNameId + ", fileId=" + fileId + ", jobId=" + jobId + ", LStat=" + LStat + ", md5=" + md5 + ", volName=" + volName + ", Inchanger=" + Inchanger + '}';
    }
