 ...
 */
public class BmtApplicationInitializer implements WebApplicationInitializer {
    
    private static final String APPLICATION_NAME = "BMT - Bacula Management Tool";
    private static final String CONFIG_LOCATION = "br.com.uktech.bmt.configuration";
