...
public class SystemUserPermission implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 59 * hash + Objects.hashCode(this.systemUserPermissionId);
        hash = 59 * hash + Objects.hashCode(this.read);
        hash = 59 * hash + Objects.hashCode(this.add);
        hash = 59 * hash + Objects.hashCode(this.edit);
        hash = 59 * hash + Objects.hashCode(this.delete);
        return hash;
    }
