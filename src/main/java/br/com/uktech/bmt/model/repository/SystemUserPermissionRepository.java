...
import br.com.uktech.bmt.model.SystemUserPermission;
import br.com.uktech.bmt.model.SystemUserPermissionId;
...
public interface SystemUserPermissionRepository extends PagingAndSortingRepository<SystemUserPermission, SystemUserPermissionId> {
    ...
    public Iterable<SystemUserPermission> findBySystemUserPermissionIdSystemUser(SystemUser systemUser);
