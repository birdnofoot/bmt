 ...
 */
public class BaculaDotStatusClientRunningMapper extends BeanMappingBuilder {
    
    @Override
    protected void configure() {
        this.mapping(BaculaDotStatusClientRunning.class, BaculaDotStatusClientRunningDto.class);
    }
